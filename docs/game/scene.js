...
export function createSceneContext(canvas) {
  ...
  composer.addPass(new UnrealBloomPass(new THREE.Vector2(window.innerWidth, window.innerHeight), 0.045, 0.34, 1.06));
